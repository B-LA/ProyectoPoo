 ...
 * @author neon
 */
public class fModificarAdmin extends javax.swing.JFrame {
conexion con = new conexion();
    /**
     * Creates new form fModificarAdmin
     */
    public fModificarAdmin(int index) {
        initComponents();
        agarrarDatos(index);
    }
int index2;
    private void agarrarDatos(int index){
    
    ArrayList<usuariosAdmin> deleT =  con.obtenerAdministradores();
 
    usuariosAdmin ad = deleT.get(index);
    String nombre = ad.getNombre();
   String contra = ad.getContra();        
    this.jTextField1.setText(nombre);
    this.jTextField2.setText(contra);
    int index2 = index+1;
       this.index2 = index2;
  ...
  int index3 = this.devolverDatos();
        modificarAdmin mod = new modificarAdmin(nombre,contra,index3);
        con.modificarUsuario(mod);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fModificarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fModificarAdmin(0).setVisible(true);
            }
        });
    }
